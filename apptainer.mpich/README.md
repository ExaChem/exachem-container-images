Slurm script for running on OLCF Frontier as of November 7th, 2025
```
ROCM_VERSION=6.4.2
module purge
...
export APPTAINERENV_LD_LIBRARY_PATH="$CRAY_MPICH_DIR/lib-abi-mpich:$CRAY_MPICH_ROOTDIR/gtl/lib:/opt/install/exachem/lib/:/lib:/opt/rocm-${ROCM_VERSION}/lib:/.singularity.d/libs:/opt/rocm-${ROCM_VERSION}/llvm/lib:$CRAY_LD_LIBRARY_PATH:$LD_LIBRARY_PATH:/opt/cray/pe/lib64:$HIP_LIB_PATH"
...
export ORGDIR=$(pwd)
export BINDS=/opt/amdgpu,/usr/share/libdrm,/var/spool/slurmd,/opt/cray,/opt/rocm--${ROCM_VERSION},${MYFS}
...
export MYIMG=oras://ghcr.io/exachem/exachem-container-images/apptainer.mpich3.4.2.amd_gfx90a_rocm6.2.4.noble:
echo MYIMG is $MYIMG
